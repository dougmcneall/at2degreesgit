...
plot(dens_1_5, pty = 'n', xlim = c(280,1000), ylim = c(0, 0.009), xlab = expression(CO[2]~conc.~(ppmv)), ylab = 'density', main = '',
     bty = 'l')
...
plot(dens_2, pty = 'n', xlim = c(280,1000), ylim = c(0, 0.009),main = '', xlab = expression(CO[2]~conc.~(ppmv)), ylab = 'density',
     bty = 'l')
...
This section plots the CO2 measured at warming levels 1.5 and 2 degrees in CMIP6 models against the CO2 levels you would expect from projecting their measured TCR through the transfer function.  
...
legend('topleft', legend = c('1.5 degrees', '2 degrees'), col = c('skyblue2', 'black') , pch = c(19,19), title = 'warming level')
