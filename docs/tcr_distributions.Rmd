...
# Plot implied CO2 at warming levels
...
cmip6_co2_conc_15 <- tfunc(tcr = tcr_cmip6_raw, c0=280, dT=1.5, dF2co2=3.71)
cmip6_co2_conc_2 <- tfunc(tcr = tcr_cmip6_raw, c0=280, dT=1.5, dF2co2=3.71)

```

## CO2 at 1.5 and 2 degrees
...
points(cmip6_co2_conc_15 , jitter(rep(0, length(cmip6_co2_conc_15)), factor = 0.01), col = 'blue', pch = 19)

legend('topright', legend = c(namelist, 'CMIP6'), col = c(cbPal, 'blue'), lwd = 3, lty = c(ltyvec, NA), pch = c(rep(NA,10), 19), bty = 'n',
       cex = 0.9)
...
points(cmip6_co2_conc_2 , jitter(rep(0, length(cmip6_co2_conc_15)), factor = 0.01), col = 'blue', pch = 19)
legend('topright', legend = c(namelist, 'CMIP6'), col = c(cbPal, 'blue'), lwd = 3, lty = c(ltyvec, NA), pch = c(rep(NA,10), 19), bty = 'n',
       cex = 0.9)
