...
# This version uses a forcing of 3.71 W/m^2 for a doubling of CO2,
# or 5.35 ln (C/C0), which is an estimate inconsistent with Richardson et al 2016
# This version for generating plots for R Betts talk 22 May 2018
...
c_at_2deg =  tfunc(tcr = tcr_range, c0 = 280, dT = 2, dF2co2=3.71)
c_at_1.5deg =  tfunc(tcr = tcr_range, c0 = 280, dT = 1.5, dF2co2=3.71)
...
# Initially used the AR5 Normal approximation of N(1.75, 0.5). This was incorrect, as I misread "likely range" (66% probability)
# as "very likely (90% probability).

# Here are some estimates of the 
...
samp_2deg = tfunc(tcr = tcr_samp, c0 = 280, dT = 2, dF2co2=3.71)
...
samp_1.5deg = tfunc(tcr = tcr_samp, c0 = 280, dT = 1.5, dF2co2=3.71)
...
R16col = rgb(col2rgb('tomato2')[1]/256,
  ...
  par(mfrow = c(2,2))
  plot(tcr_range, c_at_2deg, type = 'l', lwd = lwd, ylim = c(0, 6000),
       main = "Transfer function",
       xlab = "TCR",
  ...
  R16_2deg = tfunc(tcr = atcrpdf.trunc, c0 = 280, dT = 2, dF2co2=3.71)
  R16_2deg.trunc = R16_2deg[R16_2deg<1500]
  
  R16_1.5deg = tfunc(tcr = atcrpdf.trunc, c0 = 280, dT = 1.5, dF2co2=3.71)
